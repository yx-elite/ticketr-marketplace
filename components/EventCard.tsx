...
import { CalendarDays, MapPin, StarIcon, Ticket, PencilIcon, Check, XCircle, CircleArrowRight, LoaderCircle } from "lucide-react";
...
const EventCard = ({ eventId }: { eventId: Id<"events"> }) => {
  ...
  return (
    <div
      ...
      className={`bg-white rounded-lg shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-200 cursor-pointer overflow-hidden relative ${
      ...
      <div className={`p-6 ${imageUrl ? "relative" : ""}`}>
        ...
        <div className="flex flex-col items-end gap-2 ml-4">
          ...
          {availability.purchasedCount >= availability.totalTickets && (
            <span className="px-4 py-1.5 rounded-full bg-red-50 text-red-700 font-semibold text-sm">
              Sold Out
            </span>
          )}
        </div>
